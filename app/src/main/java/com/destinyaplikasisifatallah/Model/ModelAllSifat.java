...
public class ModelAllSifat {
    public static String[][] data = new String[][]{
            {"Adam",
                    "Tiada",
                    "Sifat mustahil yang pertama adalah Adam yang berarti tiada. Sifat ini kebalikan dari wujud yang artinya ada. Dalil naqli yang menunjukkan adanya Allah Ta’ala, yakni:\n" +
                            "“Sesungguhnya Tuhan kamu ialah Allah yang telah menciptakan langit dan bumi dalam enam masa, lalu Dia bersemayam di atas ‘Arsy . Dia menutupkan malam kepada siang yang mengikutinya dengan cepat, dan matahari, bulan dan bintang-bintang tunduk \n" +
                            "kepada perintah-Nya. Ingatlah, menciptakan dan memerintah hanyalah hak Allah. Maha Suci Allah, Tuhan semesta alam.”(QS.Al-Araf : 54).\n" +
            ...
            {"Ajzun",
                    "Lemah",
                    "Ajzun berarti lemah, merupakan lawan kata dari dari qudrat yang artinya berkuasa. Jadi Allah tidak mungkin bersifat lemah. Sebaliknya Allah Azza wa Jalla Maha Kuasa atas segala sesuatu. Tidak ada yang bisa melampui kekuasaan Allah Ta’ala. Dalam Al-Quran dijelaskan:\n" +
            ...
            },
            {
                    "Baqa",
                    "Kekal",
                    "Baqa’ berarti kekal. Maksudnya Allah itu Maha Kekal. Tidak akan punah, binasa ataupun mati. Tiada akhir bagi Allah Ta’ala. Dia akan tetap ada selamanya. Sebagaimana dijelaskan dalam Al-Quran:“Semua yang ada di bumi itu akan binasa. Dan tetap kekal Wajah Rabbmu yang mempunyai kebesaran dan kemuliaan.” (QS. Ar-Rahman: 26-27).\n" +
                            "“Tiap-tiap sesuatu pasti binasa, kecuali Allah. BagiNya-lah segala penentuan, dan hanya kepadaNya-lah kamu dikembalikan.” (QS. Al-Qasas: 88)"
            },
            {"Mukholafatul Lilhawaditsi",
                    "Berbeda dengan makhluk ciptaanNya",
                    "Allah Ta’ala sudah pasti berbeda dari makhluk ciptaanNya. Dialah dzat yang Maha Sempurna dan Maha Besar. Tidak ada sesuatu pun yang menandingi atau menyerupai keagunganNya. Ini sebagaimana dijelaskan dalam Al-Quran:“Dan tidak ada seorangpun yang setara dengan Dia.” (QS. Al-Ikhlas: 4).\n" +
                            "“Tidak ada sesuatupun yang serupa dengan Dia dan Dialah yang Maha Mendengar dan Melihat.”. (QS. Asy-Syura: 11)"
            },
            {"Qiyamuhu Binafsihi",
                    "Berdiri sendiri",
                    "Allah itu berdiri sendiri. Allah Ta’ala tidak bergantung pada apapun dan tidak membutuhkan bantuan siapapun. Dalam al-Qur’an Allah berfirman:" +
                            "“Dan barangsiapa yang berjihad, maka sesungguhnya jihadnya itu adalah untuk dirinya sendiri. Sesungguhnya Allah benar-benar Maha Kaya (tidak memerlukan sesuatu) dari alam semesta.” (QS. Al-Ankabut: 6)“Dan katakanlah segala puji bagi Allah Yang tidak mempunyai anak dan tidak mempunyai sekutu dalam kerajaan-Nya dan Dia bukan pula hina yang memerlukan penolong dan agungkanlah Dia dengan pengagungan yang sebesar-besarnya.” (QS. Al-Isra: 111)."
            },
            {"Wahdaniyah",
                    "Esa/Tunggal",
                    "Allah itu maha Esa atau Tunggal. Maksudnya Tidak ada sekutu bagiNya . Dialah satu-satunya Tuhan pencipta alam semesta. Bukti keesakan Allah terletak dalam kalimat syahadat “Laa ilaha Illallah” yang artinya “ Tiada Tuhan selain Allah” Dijelaskan juga dalam FirmanNya di Al-Quran:\n" +
